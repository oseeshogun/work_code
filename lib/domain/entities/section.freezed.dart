...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int number,  String text,  int chapterNumber,  int titleNumber,  Set<int> articles)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SectionEntity() when $default != null:
return $default(_that.number,_that.text,_that.chapterNumber,_that.titleNumber,_that.articles);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int number,  String text,  int chapterNumber,  int titleNumber,  Set<int> articles)  $default,) {final _that = this;
switch (_that) {
case _SectionEntity():
return $default(_that.number,_that.text,_that.chapterNumber,_that.titleNumber,_that.articles);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int number,  String text,  int chapterNumber,  int titleNumber,  Set<int> articles)?  $default,) {final _that = this;
switch (_that) {
case _SectionEntity() when $default != null:
return $default(_that.number,_that.text,_that.chapterNumber,_that.titleNumber,_that.articles);case _:
  return null;
