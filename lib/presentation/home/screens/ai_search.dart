            ...
            Column(
              children: [
                ...
                limitedSendChatMessageAsync.when(
                  data: (sendMessageUseCase) => AnimatedGradientBorderTextField(
